...
awful.util.spawn_with_shell("setxkbmap -option compose:ralt -option caps:super -option terminate:ctrl_alt_bksp")
...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({ "main", "chat", "code", "gimp", "game", "tune", "7", "8", "9" }, s,
...
--              {description = "show main menu", group = "awesome"}),
    ...
    -- Audio
    awful.key({ }, "XF86AudioRaiseVolume", widgets.alsa.fn_vol_up),
    awful.key({ }, "XF86AudioLowerVolume", widgets.alsa.fn_vol_down),
    awful.key({ }, "XF86AudioMute", widgets.alsa.fn_toggle_mute),
